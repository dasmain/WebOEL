            ...
            <div className="col-sm-6 text-white bg-dark">
              ...
              <div style={{ marginTop: "50px" }} className="d-flex align-items-center px-5 ms-xl-4 pt-xl-0">
                <form style={{ width: "23rem" }}>
                  ...
                  <button className="btn btn-outline-danger btn-lg btn-block" onClick={() => { onSubmit() }}>Login</button>
                    <br />
                  </div>
           
                  <br />
                  <p className="small mb-5 pb-lg-2">
                    <button className="btn btn-outline-danger btn-lg btn-block" onClick={() => { onRegister() }}>Register</button>
                    <button className="btn btn-outline-danger btn-lg btn-block" onClick={() => { onDelete() }}>Delete an Account</button>
                  </p>
                </form>
              </div>
            </div>
